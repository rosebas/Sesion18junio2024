...
public class QuerysEstadoCompra {
    private final String INSERTAR_ESTADO_COMPRA = "INSERT INTO estado_compra VALUES (?, ?)";
    private final String ACTUALIZAR_ESTADO_COMPRA = "UPDATE estado_compra SET estado = ? WHERE id_estado = ?";
    ...
    private final String CONSULTAR_ESTADO_COMPRA = "SELECT id_estado, estado FROM estado_compra WHERE"
            + " id_estado = ?";
